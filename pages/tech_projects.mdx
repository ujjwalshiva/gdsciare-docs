...
Here's our list of projects by GDSC Team
...
**Developed By:** [Ujjwal Shivacharya](https://ujjwalshiva.github.io) and [Vishnu Nadella](https://www.linkedin.com/in/vishnu-nadella-007/)
...
**Developed By:** [Vishnu Nadella](https://www.linkedin.com/in/vishnu-nadella-007/)

**Project Link:** Get the apk [here](#)
...
Here are some of the features of NBA Tracker bot:
...
<Callout emoji="🔥">
QBS Archive Web App has served more than **4200+** requests since launch 
</Callout>

QBS Archive is a website where students of IARE can obtain solutions to question bank semester wise. The solutions are contributed by students of the batch of 2024 (mostly by CSE and IT). This web app uses Tailwind UI and jsPDF to generate a beautiful looking pdf that contains link to all the required subjects
...
* Search: allows students to search for solutions by semester and subject aname.
...
<Callout emoji="🔥">
Weboris has served more than **3500+** requests since launch 
</Callout>

Weboris is a web app that helps students of IARE download lab sheets directly from the server. The app uses responsive design to check lab sheets based on roll number and fetches the required lab sheets conveniently.
